/* empty css                                 */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as renderComponent, d as addAttribute, a as createAstro } from '../chunks/astro/server_XPotyUtQ.mjs';
import 'kleur/colors';
import { $ as $$Container, a as $$Layout } from '../chunks/Layout_D58A5twf.mjs';
import { f as formatDate } from '../chunks/utils_BW1fk8xr.mjs';
import 'clsx';
import { g as getCollection } from '../chunks/_astro_content_CmhAnPMt.mjs';
...
}, "C:/Users/AXH/Documents/my-site/zab-media/mustmedia/src/components/Icons/ArticleIcon.astro", void 0);
...
}, "C:/Users/AXH/Documents/my-site/zab-media/mustmedia/src/components/Icons/VideoIcon.astro", void 0);
...
}, "C:/Users/AXH/Documents/my-site/zab-media/mustmedia/src/components/ArticleCard.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Mustmedia - Blog" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="space-y-20"> ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate` <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6"> <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8"> <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900">Our Blog</h2> <p class="font-light text-gray-500 sm:text-xl">We use an agile approach to test assumptions and connect with the needs of your audience early and often.</p> </div> <div class="grid gap-8 lg:grid-cols-2"> ${allBlogArticles.map((article) => renderTemplate`${renderComponent($$result3, "ArticleCard", $$ArticleCard, { "article": article })}`)} </div> </div> ` })} </main> ` })}`;
}, "C:/Users/AXH/Documents/my-site/zab-media/mustmedia/src/pages/articles/index.astro", void 0);

const $$file = "C:/Users/AXH/Documents/my-site/zab-media/mustmedia/src/pages/articles/index.astro";
const $$url = "/articles";
